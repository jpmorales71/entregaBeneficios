...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    entregasAuthUserSubject.add(
      EntregasAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<EntregasAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  EntregasAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = EntregasAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    entregasAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
