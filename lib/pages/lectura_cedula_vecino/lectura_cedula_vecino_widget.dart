...
class LecturaCedulaVecinoWidget extends StatefulWidget {
  ...
  @override
  State<LecturaCedulaVecinoWidget> createState() =>
      _LecturaCedulaVecinoWidgetState();
}

class _LecturaCedulaVecinoWidgetState extends State<LecturaCedulaVecinoWidget> {
  late LecturaCedulaVecinoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LecturaCedulaVecinoModel());
  }
        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              'z2i8tg5n' /* Lectura QR cedula beneficiario */,
            ),
