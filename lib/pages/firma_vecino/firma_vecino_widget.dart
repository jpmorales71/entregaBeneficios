            ...
            children: [
              Container(
                ...
                child: Container(
                  width: 400.0,
                  height: 400.0,
                  child: custom_widgets.SignatureCanvas(
                    width: 400.0,
                    height: 400.0,
                    accionGuardar: _model.guardar,
                    accionLimpiar: _model.limpiar,
                  ),
                ),
              ),
              Padding(
                      ...
                      onPressed: () async {
                        ...
                        if (confirmDialogResponse) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                'Sin Registro de Firma de Responsable!',
                                style: TextStyle(
                                  color:
