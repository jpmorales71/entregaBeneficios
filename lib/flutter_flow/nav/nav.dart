...
class AppStateNotifier extends ChangeNotifier {
  ...
  EntregasAuthUser? initialUser;
  EntregasAuthUser? user;
  ...
  void update(EntregasAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: FirmaResponsableWidget.routeName,
          path: FirmaResponsableWidget.routePath,
          builder: (context, params) => FirmaResponsableWidget(),
        ),
        FFRoute(
